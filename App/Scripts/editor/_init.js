S.editor.init = function () {
    ...
    $('.menu-bar .item-save-as').on('click', S.editor.saveAs);
    $('.menu-bar .item-content-fields').on('click', function () { S.editor.filebar.fields.show(true); });
    $('.menu-bar .item-page-resources').on('click', S.editor.filebar.resources.show);
    ...
    $('.menu-bar .item-new-folder').on('click', S.editor.folder.create.show);

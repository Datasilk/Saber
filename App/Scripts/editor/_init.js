S.editor.init = function () {
    ...
    $('.top-menu .menu-bar .item-page-titles').on('click', () => { S.editor.websettings.show('page-titles'); });
    $('.top-menu .menu-bar .item-languages').on('click', () => { S.editor.websettings.show('languages'); });

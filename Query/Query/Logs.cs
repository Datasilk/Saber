...
namespace Query
{
    public static class Logs
    {
        ...
        {
            public static List<Models.Logs.Error> GetList(int start = 0, int length = 50, string search = "")
            {
                return Sql.Populate<Models.Logs.Error>("Log_Errors_GetList", new {start, length, search});
            }
        }
        #endregion

        #region "Forgot Passwords"

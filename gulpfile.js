...
paths.working = {
    js: {
        ...
        editor: [
            ...
            paths.scripts + 'editor/notifications.js',
            paths.scripts + 'editor/importexport.js',
            paths.scripts + 'editor/market.js',
...
gulp.task('publish:step-3', function () {
    ...
    return del([
        ...
        '!' + paths.publishapp + 'wwwroot/editor/**/*',
        paths.publishapp + 'wwwroot/editor/js/editor-vendors.js',
        paths.publishapp + 'wwwroot/editor/css/editor-vendors.css',
